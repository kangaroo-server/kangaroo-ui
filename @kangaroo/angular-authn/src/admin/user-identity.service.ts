...
/**
 * This class provides a restful API for the user identity resource.
 *
 * @author Michael Krotscheck
 */
@Injectable()
export class UserIdentityService extends AbstractResourceService<UserIdentity> {

  /**
   * Create a new instance of the user identity service.
   *
