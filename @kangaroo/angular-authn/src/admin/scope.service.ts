...
/**
 * This class provides a restful API for the scope resource.
 *
 * @author Michael Krotscheck
 */
@Injectable()
export class ScopeService extends AbstractResourceService<Scope> {

  /**
   * Create a new instance of the scope service.
   *
